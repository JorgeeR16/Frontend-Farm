function traerMensajes(){
    $.ajax(
            {
            url:"http://129.151.119.148:8080/api/Message/all",
            type:"GET",
            datatype:"JSON",
...
function guardarMensajes(){
    ...
    $.ajax(
            ...
            url:"http://129.151.119.148:8080/api/Message/save",
...
function actualizarMensajes(idElemento1){
    ...
    $.ajax(
            {
            url:"http://129.151.119.148:8080/api/Message/update",
            type:"PUT",
            data:dataToSend,
...
function borrarMensajes(idElemento){
    ...
    $.ajax(
            {
            url:"http://129.151.119.148:8080/api/Message/"+idElemento,
            type:"DELETE",
            data:dataToSend,
            contentType:"application/JSON",
            datatype:"JSON",
